...
```bash
npm i webpack css-loader style-loader mini-css-extract-plugin -D
```
...
```text
npm i moment lodash
npm i webpack webpack-cli webpack-manifest-plugin -D
```
...
```bash
npm i webpack webpack-cli express webpack-dev-middleware -D
```
